...
class KPFCNN(BaseModel):
    ...
    def preprocess(self, data, attr):
        ...
        # Don't store search_tree - KDTree cannot be pickled for multiprocessing
        # It will be rebuilt in transform() method
    ...
    def transform(self, data, attr, is_test=False):
        ...
        feat = data['feat']
        # Rebuild KDTree from points (not stored in preprocess to avoid pickling issues)
    ...
    def inference_begin(self, data):
        ...
        # Rebuild search_tree from points (not stored in preprocess)
